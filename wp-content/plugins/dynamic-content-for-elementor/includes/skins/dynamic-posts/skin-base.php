...
abstract class SkinBase extends Elementor_Skin_Base
{
    ...
    protected function register_style_pagination_controls()
    {
        ...
        $this->add_responsive_control('pagination_icon_spacing_prevnext', ['label' => esc_html__('Icon Spacing', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'size_units' => ['px', 'em', 'rem', 'vw', 'custom'], 'range' => ['px' => ['max' => 50, 'min' => 0, 'step' => 1]], 'selectors' => ['{{WRAPPER}} .dce-pagination .pageprev.icon.left .fa' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagenext.icon.left .fa' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pageprev.icon.left .fas' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagenext.icon.left .fas' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pageprev.icon.left svg' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagenext.icon.left svg' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pageprev.icon.right .fa' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagenext.icon.right .fa' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pageprev.icon.right .fas' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagenext.icon.right .fas' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pageprev.icon.right svg' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagenext.icon.right svg' => 'margin-left: {{SIZE}}{{UNIT}};'], 'condition' => ['pagination_show_prevnext' => 'yes']]);
        ...
        $this->add_responsive_control('pagination_icon_spacing_firstlast', ['label' => esc_html__('Icon Spacing', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'size_units' => ['px', 'em', 'rem', 'vw', 'custom'], 'range' => ['px' => ['max' => 50, 'min' => 0, 'step' => 1]], 'selectors' => ['{{WRAPPER}} .dce-pagination .pagefirst.icon.left .fa' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagelast.icon.left .fa' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagefirst.icon.left .fas' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagelast.icon.left .fas' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagefirst.icon.left svg' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagelast.icon.left svg' => 'margin-right: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagefirst.icon.right .fa' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagelast.icon.right .fa' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagefirst.icon.right .fas' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagelast.icon.right .fas' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagefirst.icon.right svg' => 'margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-pagination .pagelast.icon.right svg' => 'margin-left: {{SIZE}}{{UNIT}};'], 'condition' => ['pagination_show_firstlast' => 'yes']]);
    ...
    {
        $post_type_label = $settings['posttype_label'];
        $type = get_post_type();
    ...
    protected function maybe_render_pagination_top()
    {
        ...
        if ($settings['pagination_enable'] && ('top' === $settings['pagination_position'] || 'both' === $settings['pagination_position'])) {
            $this->numeric_query_pagination($p_query->max_num_pages, $settings, 'dce-pagination-top', (bool) $rtl);
        }
    }
    /**
     ...
     * @return void
     */
    public function numeric_query_pagination($pages, $settings, $class = '', $rtl = \false)
    {
        ...
        if ($pages !== 1) {
            $this->get_parent()->add_render_attribute('pagination-container', 'class', 'dce-pagination');
            if ($class) {
                $this->get_parent()->add_render_attribute('pagination-container', 'class', $class);
            }
            if ($rtl) {
                $this->get_parent()->add_render_attribute('pagination-container', 'dir', 'rtl');
            }
            echo '<div ' . $this->get_parent()->get_render_attribute_string('pagination-container') . '>';
            // Progression
            if ($settings['pagination_show_progression']) {
                $this->get_parent()->add_render_attribute('progression', 'class', 'progession');
                echo '<span ' . $this->get_parent()->get_render_attribute_string('progression') . '>';
                echo $paged . ' / ' . $pages;
                echo '</span>';
            }
            // First
            if ($settings['pagination_show_firstlast']) {
                if ($paged > 2 && $paged > $range + 1 && $showitems < $pages) {
                    ...
                    $this->get_parent()->add_render_attribute('link-first', 'href', $link);
                    $classes = !empty($icons['firstlast_left']) ? 'pagefirst left icon' : 'pagefirst';
                    $this->get_parent()->add_render_attribute('link-first', 'class', $classes);
                    echo '<a ' . $this->get_parent()->get_render_attribute_string('link-first') . '>';
                    if (!empty($icons['firstlast_left'])) {
                        echo $icons['firstlast_left'] . ' ';
                    }
                    echo wp_kses_post($settings['pagination_first_label']) . '</a>';
                    $this->get_parent()->remove_render_attribute('link-first');
                }
            }
            // Prev
            if ($settings['pagination_show_prevnext']) {
                if ($paged > 1 && $showitems < $pages) {
                    ...
                    $this->get_parent()->add_render_attribute('link-prev', 'href', $link);
                    $classes = !empty($icons['prevnext_left']) ? 'pageprev icon left' : 'pageprev';
                    $this->get_parent()->add_render_attribute('link-prev', 'class', $classes);
                    echo '<a ' . $this->get_parent()->get_render_attribute_string('link-prev') . '>';
                    if (!empty($icons['prevnext_left'])) {
                        echo $icons['prevnext_left'];
                    }
                    echo wp_kses_post($settings['pagination_prev_label']) . '</a>';
                    $this->get_parent()->remove_render_attribute('link-prev');
                }
            }
            // Numbers
            if ($settings['pagination_show_numbers']) {
                for ($i = 1; $i <= $pages; $i++) {
                    if (1 != $pages && (!($i >= $paged + $range + 1 || $i <= $paged - $range - 1) || $pages <= $showitems)) {
                        ...
                        if ($paged == $i) {
                            $this->get_parent()->add_render_attribute("page-{$i}", ['class' => 'current', 'aria-current' => 'page']);
                            echo '<span ' . $this->get_parent()->get_render_attribute_string("page-{$i}") . '>' . $i . '</span>';
                        } else {
                            $this->get_parent()->add_render_attribute("page-link-{$i}", ['href' => $link, 'class' => 'inactive']);
                            echo '<a ' . $this->get_parent()->get_render_attribute_string("page-link-{$i}") . '>' . $i . '</a>';
                        }
                    }
                    $this->get_parent()->remove_render_attribute("page-{$i}");
                    $this->get_parent()->remove_render_attribute("page-link-{$i}");
                }
            }
            // Next
            if ($settings['pagination_show_prevnext']) {
                if ($paged < $pages && $showitems < $pages) {
                    $link = $search_filter_query ? $this->get_wp_link_page_sf($paged + 1) : $this->get_wp_link_page($paged + 1);
                    $this->get_parent()->add_render_attribute('next-page-link', ['href' => $link, 'class' => 'pagenext']);
                    if (!empty($icons['prevnext_right'])) {
                        $this->get_parent()->add_render_attribute('next-page-link', 'class', 'right icon');
                        echo '<a ' . $this->get_parent()->get_render_attribute_string('next-page-link') . '>' . wp_kses_post($settings['pagination_next_label']) . ' ' . $icons['prevnext_right'] . '</a>';
                    } else {
                        echo '<a ' . $this->get_parent()->get_render_attribute_string('next-page-link') . '>' . wp_kses_post($settings['pagination_next_label']) . '</a>';
                    }
                    $this->get_parent()->remove_render_attribute('next-page-link');
                }
            }
            // Last
            if ($settings['pagination_show_firstlast']) {
                if ($paged < $pages - 1 && $paged + $range - 1 < $pages && $showitems < $pages) {
                    ...
                    $this->get_parent()->add_render_attribute('last-page-link', ['href' => $link, 'class' => 'pagelast']);
                    if (!empty($icons['firstlast_right'])) {
                        $this->get_parent()->add_render_attribute('last-page-link', 'class', 'icon right');
                        echo '<a ' . $this->get_parent()->get_render_attribute_string('last-page-link') . '>' . wp_kses_post($settings['pagination_last_label']) . ' ' . $icons['firstlast_right'] . '</a>';
                    } else {
                        echo '<a ' . $this->get_parent()->get_render_attribute_string('last-page-link') . '>' . wp_kses_post($settings['pagination_last_label']) . '</a>';
                    }
                    $this->get_parent()->remove_render_attribute('last-page-link');
                }
            }
            echo '</div>';
            $this->get_parent()->remove_render_attribute('pagination-container');
        }
    }
    /**
     * @param array<string,mixed> $settings
        ...
        if ($post instanceof \WP_Post) {
            if ($i > 1) {
                if ('' === get_option('permalink_structure') || \in_array($post->post_status, ['draft', 'pending'])) {
                    ...
                    $url = trailingslashit($url) . user_trailingslashit(\strval($i), 'single_paged');
                }
            }
            if (is_preview()) {
    ...
    protected function maybe_render_pagination_bottom()
    {
        ...
        if ($settings['pagination_enable'] && ('bottom' === $settings['pagination_position'] || 'both' === $settings['pagination_position'])) {
            $this->numeric_query_pagination($p_query->max_num_pages, $settings, 'dce-pagination-bottom', (bool) $rtl);
        }
    }
    /**
     * Render Loop End
