...
class ThreesixtySlider extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->add_control('pathimages', ['label' => esc_html__('Images path', 'dynamic-content-for-elementor'), 'label_block' => \true, 'description' => esc_html__('The absolute path from root folder of the images for the 360. The images in the folder must be called with the sequential number (e.g.:1.png, or 1.svg or 1.jpg. So 2.jpg, 3.jpg, 4.jpg etc.)', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'default' => $pathimg, 'placeholder' => '/wp-content/uploads/360/', 'frontend_available' => \true]);
