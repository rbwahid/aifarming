...
class AcfRepeater extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $repeater_subfields->add_control('dce_acf_repeater_field_type', ['label' => esc_html__('ACF Type', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SELECT, 'options' => ['' => esc_html__('Select the type', 'dynamic-content-for-elementor'), 'text' => esc_html__('Text', 'dynamic-content-for-elementor'), 'textarea' => esc_html__('Textarea', 'dynamic-content-for-elementor'), 'image' => esc_html__('Image', 'dynamic-content-for-elementor'), 'wysiwyg' => esc_html__('WYSIWYG', 'dynamic-content-for-elementor'), 'date_picker' => esc_html__('Date Picker', 'dynamic-content-for-elementor'), 'date_time' => esc_html__('DateTime', 'dynamic-content-for-elementor'), 'date_time_picker' => esc_html__('DateTime Picker', 'dynamic-content-for-elementor'), 'number' => esc_html__('Number', 'dynamic-content-for-elementor'), 'select' => esc_html__('Select', 'dynamic-content-for-elementor')]]);
        ...
        $repeater_subfields->add_responsive_control('dce_acf_repeater_field_align', ['label' => esc_html__('Alignment', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'toggle' => \true, 'options' => ['left' => ['title' => esc_html__('Left', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-align-left'], 'center' => ['title' => esc_html__('Center', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-align-center'], 'right' => ['title' => esc_html__('Right', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-align-right']], 'selectors' => ['{{WRAPPER}} {{CURRENT_ITEM}}' => 'text-align: {{VALUE}};'], 'condition' => ['dce_acf_repeater_field_tag!' => '']]);
        ...
        $repeater_subfields->add_responsive_control('dce_acf_repeater_field_space', ['label' => esc_html__('Space', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['max' => 100, 'min' => 0, 'step' => 1]], 'selectors' => ['{{WRAPPER}} {{CURRENT_ITEM}}' => 'margin-bottom: {{SIZE}}{{UNIT}};'], 'condition' => ['dce_acf_repeater_field_tag!' => '']]);
        ...
        $repeater_subfields->add_control('dce_acf_repeater_h_texts', ['label' => esc_html__('Text', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::HEADING, 'separator' => 'before', 'condition' => ['dce_acf_repeater_field_type' => ['text', 'textarea', 'wysiwyg', 'date_picker', 'date_time', 'date_time_picker', 'number', 'select'], 'dce_acf_repeater_field_tag!' => '']]);
        $repeater_subfields->add_control('dce_acf_repeater_field_color', ['label' => esc_html__('Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} {{CURRENT_ITEM}}' => 'color: {{VALUE}};', '{{WRAPPER}} {{CURRENT_ITEM}} a' => 'color: {{VALUE}};'], 'condition' => ['dce_acf_repeater_field_type' => ['text', 'textarea', 'wysiwyg', 'date_picker', 'date_time', 'date_time_picker', 'number', 'select'], 'dce_acf_repeater_field_tag!' => '']]);
        $repeater_subfields->add_control('dce_acf_repeater_field_hover_color', ['label' => esc_html__('Hover Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} {{CURRENT_ITEM}} a:hover' => 'color: {{VALUE}};'], 'condition' => ['dce_acf_repeater_field_type' => ['text', 'textarea', 'wysiwyg', 'date_picker', 'date_time', 'date_time_picker', 'number', 'select'], 'dce_acf_repeater_enable_link!' => '', 'dce_acf_repeater_field_tag!' => '']]);
        ...
        $repeater_subfields->add_control('dce_acf_repeater_h_image', ['label' => esc_html__('Image', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::HEADING, 'separator' => 'before', 'condition' => ['dce_acf_repeater_field_type' => ['image'], 'dce_acf_repeater_field_tag!' => '']]);
        ...
        $repeater_subfields->add_group_control(Group_Control_Border::get_type(), ['name' => 'image_border', 'label' => esc_html__('Image Border', 'dynamic-content-for-elementor'), 'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} img', 'condition' => ['dce_acf_repeater_field_type' => ['image'], 'dce_acf_repeater_field_tag!' => '']]);
        $repeater_subfields->add_control('image_border_radius', ['label' => esc_html__('Border Radius', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px', '%'], 'selectors' => ['{{WRAPPER}} {{CURRENT_ITEM}} img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'], 'condition' => ['dce_acf_repeater_field_type' => ['image'], 'dce_acf_repeater_field_tag!' => '']]);
        ...
        $repeater_subfields->add_group_control(Group_Control_Css_Filter::get_type(), ['name' => 'filters_image', 'label' => esc_html__('Filters image', 'dynamic-content-for-elementor'), 'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} img', 'condition' => ['dce_acf_repeater_field_type' => ['image'], 'dce_acf_repeater_field_tag!' => '']]);
        $repeater_subfields->end_controls_tab();
        ...
        $this->add_control('title_background', ['label' => esc_html__('Background', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .acc_head' => 'background-color: {{VALUE}};']]);
        $this->add_control('title_active_background', ['label' => esc_html__('Active Background', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .acc_active .acc_head' => 'background-color: {{VALUE}};']]);
        $this->add_control('title_color', ['label' => esc_html__('Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .acc_head *' => 'color: {{VALUE}};']]);
        $this->add_control('tab_active_color', ['label' => esc_html__('Active Color', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .acc_active .acc_head *' => 'color: {{VALUE}};']]);
        $this->add_group_control(Group_Control_Typography::get_type(), ['name' => 'title_typography', 'selector' => '{{WRAPPER}} .acc_head']);
        $this->add_responsive_control('title_padding', ['label' => esc_html__('Padding', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px', 'em', '%'], 'selectors' => ['{{WRAPPER}} .acc_head' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};']]);
        ...
        $this->add_responsive_control('icon_space', ['label' => esc_html__('Spacing', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 0, 'max' => 100]], 'selectors' => ['{{WRAPPER}} .acc_head .icon' => 'margin-right: {{SIZE}}{{UNIT}}; margin-left: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .acc_head .icon-active' => 'margin-right: {{SIZE}}{{UNIT}}; margin-left: {{SIZE}}{{UNIT}};']]);
    ...
    protected function safe_render()
    {
        ...
        $sub_fields_data = Helper::get_acf_repeater_fields($settings['dce_acf_repeater']);
                ...
                if (empty($paginations) || \in_array(get_row_index(), $paginations)) {
                    switch ($settings['dce_acf_repeater_format']) {
                        ...
                        case 'accordion':
                            ...
                            $this->render_accordion_heading($sub_fields_data);
                            ?></div>
								<div>
							<?php 
                    }
                    ...
                    if ($settings['dce_acf_repeater_mode'] == 'html') {
                        foreach ($sub_fields_data as $key => $value) {
                            $text = $settings['dce_acf_repeater_html'];
                            $value = get_sub_field($key);
                            $sub_fields_row[get_row_index()][$key] = $value;
                        }
                        $data = $sub_fields_row[get_row_index()];
                        // Tokens [ROW]
                        // Dynamic Shortcodes {data:row}
                        echo Plugin::instance()->text_templates->expand_shortcodes_or_callback($text, ['row' => $data, 'row-index' => get_row_index()], function ($str) use($data) {
                            if ('[ROW:id]' === $str) {
                                ...
                                switch ($field_type) {
                                    ...
                                    case 'image':
                                        ...
                                        if (\is_string($sub_field)) {
                                            ...
                                            $imageAlt = esc_attr(wp_strip_all_tags(get_post_meta($sub_field, '_wp_attachment_image_alt', \true), \true));
                                        } elseif (\is_array($sub_field)) {
                                            $imageSrc = Group_Control_Image_Size::get_attachment_image_src($sub_field['ID'], 'imgsize', $settings);
                                            $imageAlt = esc_attr($sub_field['alt']);
                                        }
    ...
    /**
     * @param array<mixed> $sub_fields_data
     * @return void
     */
    protected function render_accordion_heading($sub_fields_data)
    {
        $settings = $this->get_settings_for_display();
        foreach ($sub_fields_data as $key => $value) {
            $text = $settings['dce_acf_repeater_html'];
        ...
        // Tokens [ROW]
        // Dynamic Shortcodes {data:row} + {data:row-index}
        $data_heading = $sub_fields_row[get_row_index()];
        $title = Plugin::instance()->text_templates->expand_shortcodes_or_callback($settings['dce_acf_repeater_accordion_heading'], ['row' => $data_heading, 'row-index' => get_row_index()], function ($str) use($data_heading) {
            if ('[ROW:id]' === $str) {
                return get_row_index();
            }
