...
class BgCanvas extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->add_control('postprocessing_film', ['label' => '<b>' . esc_html__('Film', 'dynamic-content-for-elementor') . '</b>', 'type' => Controls_Manager::SWITCHER, 'default' => '', 'return_value' => 'yes', 'frontend_available' => \true, 'separator' => 'before']);
        ...
        $this->add_control('postprocessing_halftone', ['label' => '<b>' . esc_html__('Halftone', 'dynamic-content-for-elementor') . '</b>', 'type' => Controls_Manager::SWITCHER, 'default' => '', 'return_value' => 'yes', 'frontend_available' => \true, 'separator' => 'before']);
        ...
        $this->add_control('postprocessing_rgbShiftShader', ['label' => '<b>' . esc_html__('RGB Shift Shader', 'dynamic-content-for-elementor') . '</b>', 'type' => Controls_Manager::SWITCHER, 'default' => '', 'return_value' => 'yes', 'frontend_available' => \true, 'separator' => 'before']);
        ...
        $this->add_control('postprocessing_glitch', ['label' => '<b>' . esc_html__('Glitch', 'dynamic-content-for-elementor') . '</b>', 'type' => Controls_Manager::SWITCHER, 'default' => '', 'return_value' => 'yes', 'frontend_available' => \true, 'separator' => 'before']);
        // ----------- dot
        $this->add_control('postprocessing_dot', ['label' => '<b>' . esc_html__('Dot', 'dynamic-content-for-elementor') . '</b>', 'type' => Controls_Manager::SWITCHER, 'default' => '', 'return_value' => 'yes', 'frontend_available' => \true, 'separator' => 'before']);
        ...
        $this->add_control('postprocessing_pixels', ['label' => '<b>' . esc_html__('Pixels', 'dynamic-content-for-elementor') . '</b>', 'type' => Controls_Manager::SWITCHER, 'default' => '', 'return_value' => 'yes', 'frontend_available' => \true, 'separator' => 'before']);
