        ...
        if (\function_exists('yoast_breadcrumb') && $this->is_yoast_breadcrumbs()) {
            ...
            if (!is_front_page()) {
                ...
                if (is_single()) {
                    ...
                    // Display author name
                    echo '<li class="item-current item-current-' . $userdata->user_nicename . '"><span class="bread-current bread-current-' . $userdata->user_nicename . '" title="' . $userdata->display_name . '">' . esc_html__('Author', 'dynamic-content-for-elementor') . $userdata->display_name . '</span></li>';
                    ...
                    // Search results page
                    echo '<li class="item-current item-current-' . get_search_query() . '"><span class="bread-current bread-current-' . get_search_query() . '" title="' . esc_html__('Search results for:', 'dynamic-content-for-elementor') . ' ' . get_search_query() . '">' . esc_html__('Search results for:', 'dynamic-content-for-elementor') . ' ' . get_search_query() . '</span></li>';
                } elseif (is_404()) {
                    // 404 page
