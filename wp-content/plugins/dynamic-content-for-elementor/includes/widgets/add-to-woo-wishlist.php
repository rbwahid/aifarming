...
class AddToWooWishlist extends \DynamicContentForElementor\Widgets\AddToFavorites
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->update_control('dce_favorite_title_add', ['default' => esc_html__('Add to my Wishlist', 'dynamic-content-for-elementor')]);
        $this->update_control('dce_favorite_title_remove', ['default' => esc_html__('Remove from my Wishlist', 'dynamic-content-for-elementor')]);
        ...
        $this->update_control('dce_favorite_msg_add', ['default' => esc_html__('Product added to your wishlist', 'dynamic-content-for-elementor')]);
        $this->update_control('dce_favorite_msg_remove', ['default' => esc_html__('Product removed from your wishlist', 'dynamic-content-for-elementor')]);
    }
}
