...
class Rellax extends \DynamicContentForElementor\Extensions\ExtensionPrototype
{
    ...
    private function add_controls($element, $args)
    {
        ...
        $element->add_control('enabled_rellax', ['label' => esc_html__('Rellax', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => '', 'return_value' => 'yes', 'frontend_available' => \true]);
        $element->add_responsive_control('speed_rellax', ['label' => esc_html__('Speed', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'default' => ['size' => 0], 'range' => ['px' => ['min' => -10, 'max' => 10, 'step' => 0.1]], 'render_type' => 'template', 'frontend_available' => \true, 'condition' => ['enabled_rellax' => 'yes']]);
        $element->add_responsive_control('percentage_rellax', ['label' => esc_html__('Percentage', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'default' => ['size' => 0.5], 'range' => ['px' => ['min' => 0, 'max' => 1, 'step' => 0.01]], 'render_type' => 'template', 'condition' => ['enabled_rellax' => 'yes']]);
        $element->add_control('zindex_rellax', ['label' => esc_html__('z-index', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::NUMBER, 'default' => 0, 'min' => -1, 'max' => 50, 'step' => 1, 'condition' => ['enabled_rellax' => 'yes']]);
    }
