...
class Unwrap extends \DynamicContentForElementor\Extensions\ExtensionPrototype
{
    ...
    {
        $element->add_control('dce_unwrap', ['label' => esc_html__('Unwrap Element', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER]);
        $element->add_control('dce_unwrap_warning', ['raw' => '<strong>' . esc_html__('Please note!', 'dynamic-content-for-elementor') . '</strong> ' . esc_html__('Removing the wrappers could disable all styles and javascript features on the element', 'dynamic-content-for-elementor') . '<br><a target="_blank" href="https://help.dynamic.ooo/en/articles/4952484-unwrap">' . esc_html__('Read how and why you should use it', 'dynamic-content-for-elementor') . '</a>', 'type' => Controls_Manager::RAW_HTML, 'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning', 'render_type' => 'ui', 'condition' => ['dce_unwrap!' => '']]);
        $element->add_control('dce_unwrap_style', ['label' => esc_html__('Try to force Element Style', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes', 'condition' => ['dce_unwrap!' => '']]);
        $element->add_control('dce_unwrap_strip', ['label' => esc_html__('Strip selected Tags', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'placeholder' => 'div, p, span', 'condition' => ['dce_unwrap!' => '']]);
    }
    protected function add_actions()
    {
        ...
        add_action('elementor/documents/register_controls', function ($element) {
            ...
            $element->start_controls_section($section_name, ['tab' => Controls_Manager::TAB_ADVANCED, 'label' => esc_html__('Unwrap', 'dynamic-content-for-elementor')]);
