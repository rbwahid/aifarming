...
class Save extends \ElementorPro\Modules\Forms\Classes\Action_Base
{
    ...
    public function register_settings_section($widget)
    {
        ...
        $widget->add_control('dce_form_save_type_user_username', ['label' => esc_html__('Username', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'description' => esc_html__('Use field Shortcode for Username or leave it empty for a random value', 'dynamic-content-for-elementor'), 'condition' => ['dce_form_save_type' => 'user', 'dce_form_save_override' => ''], 'label_block' => 'true', 'separator' => 'before']);
