...
EOD;
    ...
    {
        $key = $key ?? '';
        $label = esc_html__('Coinmarketcap API Key', 'dynamic-content-for-elementor');
        $content = <<<EOD
...
EOD;
	...
	<div class="wrap">
        ...
        if (isset($_POST['save-dce-apis'])) {
            ...
            \DynamicContentForElementor\Plugin::instance()->admin_pages->notices->success(esc_html__('Your preferences have been saved.', 'dynamic-content-for-elementor'));
        }
        ...
        ?>
							...
							&nbsp;<a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">
								<?php 
        _e('Learn more about the API Key for Google Maps', 'dynamic-content-for-elementor');
        ?>
							</a>
							</div>
						</td>
			...
			<?php 
        submit_button(esc_html__('Save Integrations', 'dynamic-content-for-elementor'));
        ?>
