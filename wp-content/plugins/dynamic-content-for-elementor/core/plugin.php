...
class Plugin
{
    ...
    {
        $links['config'] = '<a title="' . esc_html__('Features', 'dynamic-content-for-elementor') . '" href="' . admin_url() . 'admin.php?page=dce-features">' . esc_html__('Features', 'dynamic-content-for-elementor') . '</a>';
        return $links;
    }
    public function plugin_row_meta($plugin_meta, $plugin_file)
    {
        if ('dynamic-content-for-elementor/dynamic-content-for-elementor.php' === $plugin_file) {
            $row_meta = ['docs' => '<a href="https://help.dynamic.ooo/" aria-label="' . esc_attr(esc_html__('View Documentation', 'dynamic-content-for-elementor')) . '" target="_blank">' . esc_html__('Docs', 'dynamic-content-for-elementor') . '</a>', 'community' => '<a href="https://facebook.com/groups/dynamic.ooo" aria-label="' . esc_attr(esc_html__('Facebook Community', 'dynamic-content-for-elementor')) . '" target="_blank">' . esc_html__('FB Community', 'dynamic-content-for-elementor') . '</a>'];
