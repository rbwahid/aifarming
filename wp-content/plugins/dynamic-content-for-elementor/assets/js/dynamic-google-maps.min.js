...
const marker=new google.maps.marker.AdvancedMarkerElement({position,map,content:(icon)?markerElement:undefined,});if(animation){markerElement.style.animation=animation}
