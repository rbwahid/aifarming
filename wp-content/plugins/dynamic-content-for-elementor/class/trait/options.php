...
trait Options
{
    ...
    {
        $gravatar_images = array('404' => esc_html__('404 (empty with fallback)', 'dynamic-content-for-elementor'), 'retro' => esc_html__('8bit', 'dynamic-content-for-elementor'), 'monsterid' => esc_html__('Monster (Default)', 'dynamic-content-for-elementor'), 'wavatar' => esc_html__('Cartoon face', 'dynamic-content-for-elementor'), 'indenticon' => esc_html__('The Quilt', 'dynamic-content-for-elementor'), 'mp' => esc_html__('Mystery', 'dynamic-content-for-elementor'), 'mm' => esc_html__('Mystery Man', 'dynamic-content-for-elementor'), 'robohash' => esc_html__('RoboHash', 'dynamic-content-for-elementor'), 'blank' => esc_html__('Transparent GIF', 'dynamic-content-for-elementor'), 'gravatar_default' => esc_html__('The Gravatar logo', 'dynamic-content-for-elementor'));
