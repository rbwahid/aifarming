...
class Manager
{
    ...
    public function get_plugin_info()
    {
        ...
        if (\false === $remote) {
            ...
            $remote = wp_remote_get(DCE_LICENSE_URL . '/dynamic-shortcodes/info.php', ['timeout' => 10, 'headers' => ['Accept' => 'application/json'], 'body' => ['s' => $license_system->get_current_domain(), 'v' => DCE_VERSION, 'k' => $license_system->get_license_key(), 'beta' => \false, 'from_dce' => \true]]);
