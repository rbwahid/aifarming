	...
	public static function get_all_features_data() {
		return [
			...
			'ext_unwrap' => [
				...
				'category' => 'COMMON',
				'title' => esc_html__( 'Unwrap', 'dynamic-content-for-elementor' ),
				'description' => esc_html__( 'Remove extra Elementor wrapper divs', 'dynamic-content-for-elementor' ),
				'icon' => 'icon-dce-unwrap',
				'plugin_depends' => '',
				'doc_url' => 'unwrap/',
			],
			'ext_video' => [
			...
			'wdg_remotecontent' => [
				...
				'title' => esc_html__( 'Remote Content', 'dynamic-content-for-elementor' ),
				'description' => esc_html__( 'Dynamically read any type of content from the web, incorporate text blocks, pictures and more from external sources. Compatible with REST APIs, including the native ones from WordPress. Option to format the resulting values in JSON', 'dynamic-content-for-elementor' ),
				'icon' => 'icon-dce-remotecontent',
				'plugin_depends' => '',
				'doc_url' => 'remote-content/',
			...
			'wdg_iframe' => [
				...
				'description' => esc_html__( 'Insert an iFrame', 'dynamic-content-for-elementor' ),
			...
			'wdg_google_doc_preview' => [
				...
				'description' => esc_html__( 'Display a preview of your document. For example: PDF, MS Office documents, Google docs, sheets, slides, forms and drawings', 'dynamic-content-for-elementor' ),
